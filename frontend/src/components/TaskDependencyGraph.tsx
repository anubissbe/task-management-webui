  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-3 py-1 text-sm rounded transition-colors ${
                showCriticalPath
                  ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-200 border border-yellow-300 dark:border-yellow-700'
                  ...
                  <div className="text-xs">
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      <span className={`px-1 py-0.5 rounded text-xs ${
                        node.task.priority === 'critical' ? 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-200' :
                        node.task.priority === 'high' ? 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-200' :
                        node.task.priority === 'medium' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-200' :
      ...
      <div className="mt-4 grid grid-cols-4 gap-4 text-sm">
        ...
        <div className="text-center">
          <div className="font-semibold text-yellow-600 dark:text-yellow-400">{criticalPath.length}</div>
