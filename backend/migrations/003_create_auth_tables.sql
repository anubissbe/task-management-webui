-- Authentication and Team Management Schema
-- Migration 003: Create users, teams, and permissions tables
...
-- Note: In production, this should be done through a separate seeding process
INSERT INTO users (
    email, 
    password_hash, 
    first_name, 
