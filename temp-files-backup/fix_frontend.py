...
try:
    ...
    # Create corrected frontend HTML
    ssh.sendline("echo 'JDU9xjn1ekx3rev_uma'  < /dev/null |  sudo -S tee /volume1/docker/projecthub-frontend/index.html > /dev/null << 'EOFHTML'")
    ...
    <div class="container">
        <div class="main-content">
            <div class="card">
                ...
                <button class="btn" onclick="window.checkHealth()">Refresh Status</button>
            ...
            <div class="card">
                ...
                <button class="btn" onclick="window.loadProjects()">Refresh Projects</button>
            </div>
